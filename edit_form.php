...
class block_dashboard_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $setupurl = new moodle_url('/blocks/dashboard/setup.php', array('id' => $COURSE->id, 'instance' => $this->block->instance->id));
        $generalparamslink = '<a href="'.$setupurl.'">'.$generalparamsconfigstr.'</a>';
        ...
        $importurl = new moodle_url('/blocks/dashboard/copyconfig.php', array('id' => $COURSE->id, 'instance' => $this->block->instance->id, 'what' => 'get'));
        $import_export = '<a href="'.$importurl.'" target="_blank">'.$exportconfigstr.'</a>';
