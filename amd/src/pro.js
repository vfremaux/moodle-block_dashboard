...
define(['jquery', 'core/log', 'core/config'], function($, log, cfg) {
    ...
    var blockdashboardpro = {

        component: 'block_dashboard',
        shortcomponent: 'block_dashboard',
        componentpath: 'blocks/dashboard',

        init: function() {

            var licensekeyid = '#id_s_' + blockdashboardpro.component + '_licensekey';
            $(licensekeyid).bind('change', this.check_product_key);
            $(licensekeyid).trigger('change');
            log.debug('AMD Pro js initialized for ' + blockdashboardpro.component + ' system');
        },
        ...
        check_product_key: function() {
            ...
            var calculated = blockdashboardpro.checksum(payload);
            ...
            if (crc === calculated) {
                var url = cfg.wwwroot + '/' + blockdashboardpro.componentpath + '/pro/ajax/services.php?';
                url += 'what=license';
                url += '&service=check';
                url += '&customerkey=' + that.val();
                url += '&provider=' + $('#id_s_' + blockdashboardpro.component + '_licenseprovider').val();
